...
error_listening_event = pygame.event.Event(
    ui_type, method='done_listening', message="I couldn't understand that.")
done_listening_event = pygame.event.Event(
    ui_type, method='done_listening', message=None)
